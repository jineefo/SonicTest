...
import org.vinuxproject.audio.touchsource.SoundStreamAudioPlayer;
...
public class Main1Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.text_player_record).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Main1Activity.this, RecordActivity.class);
    ...
    private void initPlayer() {
        f = new File(getExternalCacheDir()+"/bjbj.mp3");
        if (!f.exists()) {
            try {
